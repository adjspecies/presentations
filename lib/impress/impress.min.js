...
// about it!
t.scrollTo(0,0);var u=g["impress-"+e.id];// If we are in fact moving to another step, start with executing the registered
// preStepLeave plugins.
if(i=void 0===i?u.transitionDuration:i,v&&v!==e){var c={target:v,detail:{}};if(c.detail.next=e,c.detail.transitionDuration=i,c.detail.reason=n,r&&(c.origEvent=r),!1===f(c))// PreStepLeave plugins are allowed to abort the transition altogether, by
// returning false.
// see stop and substep plugins for an example of doing just that
return!1;// Plugins are allowed to change the detail values
e=c.detail.next,u=g["impress-"+e.id],i=c.detail.transitionDuration}v&&(v.classList.remove("active"),m.classList.remove("impress-on-"+v.id)),e.classList.add("active"),m.classList.add("impress-on-"+e.id);// Compute target state of the canvas based on given step
var y={rotate:{x:-u.rotate.x,y:-u.rotate.y,z:-u.rotate.z,order:u.rotate.order},translate:{x:-u.translate.x,y:-u.translate.y,z:-u.translate.z},scale:1/u.scale},h=y.scale>=b.scale;// Check if the transition is zooming in or not.
//
...
e===v&&(C=p(w));var x=y.scale*C;// Trigger leave of currently active element (if it's not the same step again)
...
// of transform.
perspective:w.perspective/x+"px",transform:d(x),transitionDuration:i+"ms",transitionDelay:(h?E:0)+"ms"}),a(I,{transform:l(y.rotate,!0)+o(y.translate),transitionDuration:i+"ms",transitionDelay:(h?0:E)+"ms"}),(b.scale===y.scale||b.rotate.x===y.rotate.x&&b.rotate.y===y.rotate.y&&b.rotate.z===y.rotate.z&&b.translate.x===y.translate.x&&b.translate.y===y.translate.y&&b.translate.z===y.translate.z)&&(E=0),b=y,v=e,t.clearTimeout(M),M=t.setTimeout(function(){z(v)},i+E),e},O=function(e){var t=E.indexOf(v)-1;return t=0<=t?E[t]:E[E.length-1],q(t,void 0,"prev",e)},K=function(e){var t=E.indexOf(v)+1;return t=t<E.length?E[t]:E[0],q(t,void 0,"next",e)},W=function(e,t,i){return e+(t-e)*i},V=function(e){if(!(1<i(e))){// Prepare & execute the preStepLeave event
...
return!1;var n=t.detail.next,r=g["impress-"+n.id],p=r.scale*C,m=i(e),u={translate:{x:W(b.translate.x,-r.translate.x,m),y:W(b.translate.y,-r.translate.y,m),z:W(b.translate.z,-r.translate.z,m)},rotate:{x:W(b.rotate.x,-r.rotate.x,m),y:W(b.rotate.y,-r.rotate.y,m),z:W(b.rotate.z,-r.rotate.z,m),// Unfortunately there's a discontinuity if rotation order changes. Nothing I
// can do about it?
...
// we need to 'scale' the perspective, too
perspective:w.perspective/u.scale+"px",transform:d(u.scale),transitionDuration:"0ms",transitionDelay:"0ms"}),a(I,{transform:l(u.rotate,!0)+o(u.translate),transitionDuration:"0ms",transitionDelay:"0ms"})}},j=function(){s.gc.teardown(),delete c["impress-root-"+n]};// Element of currently active step
...
s.gc.addEventListener(S,"impress:stepenter",function(i){t.location.hash=e="#/"+i.target.id},!1),s.gc.addEventListener(t,"hashchange",function(){t.location.hash!==e&&q(s.util.getElementFromHash())},!1),q(s.util.getElementFromHash()||E[0],0)},!1),m.classList.add("impress-disabled"),c["impress-root-"+n]={init:H,goto:q,next:K,prev:O,swipe:V,tear:j,lib:s}};b.supported=u;// ADD and INIT LIBRARIES
...
var u=a.firstChild,c=u.innerHTML;if(a.innerHTML=c,void 0!==s[t]&&(delete s[t],n--),0===n){e.body.classList.remove("impress-supported"),r.body.impressNotSupported&&e.body.classList.add("impress-not-supported");// We need to remove or reset the meta element inserted by impress.js
...
p=u(t),p.addEventListener("click",function(){c(),"playing"===d?(0===i&&(i=7),0===s&&(s=i),l(s)):"paused"===d&&l(0)}),m(e,"impress:toolbar:appendChild",{group:10,element:p})};/*** Toolbar plugin integration *******************************************/}(document),function(e){"use strict";var t=null,i=!1,s=function(e,t){var i,s;for(i in t)t.hasOwnProperty(i)&&(s=n(i),null!==s&&(e.style[s]=t[i]));return e},n=function(){var t=e.createElement("dummy").style,s=["Webkit","Moz","O","ms","Khtml"],n={};return function(e){if("undefined"==typeof n[e]){var r=e.charAt(0).toUpperCase()+e.substr(1),a=(e+" "+s.join(r+" ")+r).split(" ");for(var o in n[e]=null,a)if(void 0!==t[a[o]]){n[e]=a[o];break}}return n[e]}}(),r=function(){i&&(s(t,{display:"block"}),i=!1)},a=function(){i?r():(s(t,{display:(i=!i)?"none":"block"}),i=!0)};// Wait for impress.js to be initialized
...
var c=e.getElementById(s),g=null,v=function(){// Return to parents as long as there is no next sibling
...
var n=e.URL.substring(0,e.URL.search("#/")),r=n+"#"+e.querySelector(".active").id,a=n+"#"+v().id,o=g.document.getElementById("slideView");o.src!==r&&(o.src=r);var l=g.document.getElementById("preView");l.src!==a&&(l.src=a),g.document.getElementById("status").innerHTML="<span  class=\"ready\">"+i.ready+"</span>"}},b=function(e){g&&("next"===e.detail.reason&&E(),"prev"===e.detail.reason&&x())},E=function(){var e=g.document.getElementById("slideView");L(e,"impress:substep:show")},x=function(){var e=g.document.getElementById("slideView");L(e,"impress:substep:hide")},L=function(e,t,i){// Note: Unfortunately Chrome does not allow createEvent on file:// URLs, so this won't
...
"<!DOCTYPE html><html id=\"impressconsole\"><head>{{cssStyle}}{{cssLink}}</head><body><div id=\"console\"><div id=\"views\"><iframe id=\"slideView\" scrolling=\"no\"></iframe><iframe id=\"preView\" scrolling=\"no\"></iframe><div id=\"blocker\"></div></div><div id=\"notes\"></div></div><div id=\"controls\"> <div id=\"prev\"><a  href=\"#\" onclick=\"impress().prev(); return false;\" />{{prev}}</a></div><div id=\"next\"><a  href=\"#\" onclick=\"impress().next(); return false;\" />{{next}}</a></div><div id=\"clock\">--:--</div><div id=\"timer\" onclick=\"timerReset()\">00m 00s</div><div id=\"status\">{{loading}}</div></div></body></html>".replace("{{cssStyle}}",u()).replace("{{cssLink}}",a).replace(/{{.*?}}/gi,function(e){return i[e.substring(2,e.length-2)]})),g.document.title="Speaker Console ("+e.title+")",g.impress=t.impress,g.isconsoleWindow=!0,g.onload=S,g.timerStart=new Date,g.timerReset=w,g.clockInterval=setInterval(d[s].clockTick,1e3),C([33,37,38],t.impress().prev),C([34,39,40],t.impress().next),C([32],f),C([82],w),g.onbeforeunload=function(){clearInterval(g.clockInterval)},h(),g.initialized=!1,g.document.close(),t.onresize=D,g.onresize=D,g}},D=function(){var e=g.document.getElementById("slideView"),i=g.document.getElementById("preView"),s=t.innerHeight/t.innerWidth,o=g.document.getElementById("views"),l=e.offsetWidth-e.clientWidth,d=o.clientWidth-l,p=m(d*s),u=p+a,c=m(d*n),v=m(p*n);o.clientHeight-l<u+v&&(v=o.clientHeight-l-u,c=m(v/s)),c<=m(d*r)&&(d=o.clientWidth-l,p=m((o.clientHeight-l-a)/(1+r)),u=p+a,c=m(d*r),v=o.clientHeight-l-u),e.style.width=d+"px",e.style.height=p+"px",i.style.top=u+"px",i.style.width=c+"px",i.style.height=v+"px"},N=function(e,i){void 0===e?void 0!==c.dataset.consoleCss&&(o=c.dataset.consoleCss):o=e,void 0===i?void 0!==c.dataset.consoleCssIframe&&(l=c.dataset.consoleCssIframe):l=i,c.addEventListener("impress:stepleave",y),c.addEventListener("impress:stepenter",h),c.addEventListener("impress:substep:stepleaveaborted",b),c.addEventListener("impress:substep:show",E),c.addEventListener("impress:substep:hide",x),t.onunload=function(){g&&!g.closed&&g.close()},C([80],I,t),"true"===c.dataset.consoleAutolaunch&&t.open()};return c.addEventListener("impress:console:open",function(){I()}),c.addEventListener("impress:console:registerKeyEvent",function(e){C(e.detail.keyCodes,e.detail.handler,e.detail.window)}),d[s]={init:function(e,i){(void 0===e||"css/impressConsole.css"===e)&&(void 0===i||i==="css/iframe.css")&&t.console.log("impressConsole().init() is deprecated. impressConsole is now initialized automatically when you call impress().init()."),N(e,i)},open:I,clockTick:k,registerKeyEvent:C,_init:N},d[s]};e.addEventListener("impress:init",function(t){// Note: impressConsole wants the id string, not the DOM element directly
...
e.addEventListener("impress:navigation-ui:hideStep",function(e){l.push(e.target),a&&(a.innerHTML=m())},!1),e.addEventListener("impress:init",function(i){t=e.querySelector("#impress-toolbar"),t&&u(i)},!1)}(document),function(e){"use strict";// Wait for impress.js to be initialized
...
t.impress().goto(e.querySelector("#impress .step.active"))})}(document,window);
